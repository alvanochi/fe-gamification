        ...
        <div className="mx-auto max-w-2xl">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h1 className="mt-2 font-display text-3xl text-ink sm:text-4xl">Penjagaan Pos</h1>
            </div>
            <AdminNav />
          </div>
          <p className="mt-2 text-sm text-ink/60">
            Pilih pos yang kamu jaga, lalu pindai QR peserta saat kelompoknya tiba dan saat pergi.
            Kelompoknya ditemukan sendiri oleh sistem — kamu tidak perlu bertanya mereka dari
            kelompok mana.
          </p>
